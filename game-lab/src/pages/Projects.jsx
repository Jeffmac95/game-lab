    ...
    return (
        <div className="flex flex-col items-center px-6">
            ...
            <div className="flex flex-col justify-center items-center mt-8 p-4 border-t self-stretch">
                <h2 className="text-xl text-accent">Worklog System</h2>
            ...
            <div className="flex flex-col justify-center items-center mt-8 p-4 border-t self-stretch">
                <h2 className="text-xl text-accent">Milky Way Defender</h2>
            ...
            <div className="flex flex-col justify-center items-center mt-8 p-4 border-t self-stretch">
                <h2 className="text-xl text-accent">Pixcraft</h2>
            ...
            <div className="flex flex-col justify-center items-center mt-8 p-4 border-t self-stretch">
                <h2 className="text-xl text-accent">Tincan</h2>
